---
name: ui-ux-pro-max
description: Inteligência de Design de Interfaces (Design System). Use para buscar paletas, componentes e bibliotecas modernas (Tailwind/React). Base de conhecimento para interfaces web premium e acessíveis.
---
# ui-ux-pro-max
